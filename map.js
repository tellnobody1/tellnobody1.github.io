...
const addPlane = (label, lng, lat) => {
  ...
  el.className = 'plane'
  new mapboxgl.Marker(el).setLngLat([lng, lat]).setPopup(new mapboxgl.Popup().setText(label)).addTo(map)
}
addMarker('Aegina', 23.433333, 37.75, '#3fb1ce')
addMarker('Amsterdam', 4.89516789999993, 52.3702157, '#3fb1ce')
addMarker('Athens', 23.7275388, 37.9838096, '#3fb1ce')
addMarker('Atlantic City', -74.4229266, 39.3642834, '#3fb1ce')
addMarker('Berlin', 13.404954, 52.5200066, '#3fb1ce')
addMarker('Boston', -71.0588801, 42.3600825, '#3fb1ce')
addMarker('Brighton', -0.131312, 50.842941, '#3fb1ce')
addMarker('Bristol', -2.58790999999997, 51.454513, '#3fb1ce')
addMarker('Budapest', 19.0402349999999, 47.497912, '#3fb1ce')
addMarker('Cambridge', -71.1097335, 42.3736158, '#3fb1ce')
addMarker('Cape May', -74.9060053, 38.9351125, '#3fb1ce')
addMarker('Cologne', 6.96027860000004, 50.937531, '#3fb1ce')
addMarker('Costa Adeje', -16.7319493, 28.0766856, '#3fb1ce')
addMarker('Fano', 13.0194200999999, 43.8398164, '#3fb1ce')
addMarker('Florence', 11.2480006000001, 43.7710332, '#3fb1ce')
...
addMarker('Pisa', 10.4016888, 43.7228386, '#3fb1ce')
addMarker('Poros', 23.483333, 37.516667, '#3fb1ce')
addMarker('Przemysl', 22.7677908000001, 49.7838623, '#3fb1ce')
addMarker('Quebec City', -71.2079809, 46.8138783, '#3fb1ce')
addMarker('Ravenna', 12.2035294, 44.4183598, '#3fb1ce')
addMarker('Rimini', 12.5646002999999, 44.0570817, '#3fb1ce')
addMarker('Rome', 12.4963655, 41.9027835, '#3fb1ce')
addMarker('Salzburg', 13.0550089851022, 47.8111726667431, '#3fb1ce')
...
addMarker('Venice', 12.3155151, 45.4408474, '#3fb1ce')
...
addMarker('Івано-Франківськ', 24.7111170000001, 48.922633, '#0288d1')
addMarker('Львів', 24.029717, 49.839683, '#0288d1')
addMarker('Одеса', 30.7326, 46.484583, '#0288d1')
addMarker('Хотин', 26.5, 48.5, '#0288d1')
addMarker('Чернівці', 25.9358367, 48.2920787, '#0288d1')
addMarker('Чернігів', 31.28935, 51.4982, '#0288d1')
addMarker(`Кам'янець-Подільський`, 26.5833333, 48.6833333, '#0288d1')

addPlane('Edinburgh', -3.188267, 55.953252)
addPlane('Istanbul', 28.9783589, 41.0082376)
addPlane('Kumano', 136.1002367, 33.8886037)
addPlane('Kyoto Prefecture', 135.7555968, 35.0212466)
addPlane('Nara', 135.8050002, 34.6850869)
